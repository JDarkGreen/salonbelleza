...
<?php  
	...
	$name_empresa  = "Central Glam";
	$link_web      = "http://iuigv.com/salon/web/";
	$url_image     = "http://iuigv.com/salon/web/wp-content/themes/glam-customtheme/assets/images/salon_logo.png";
?>
		...
		<tr>
			<td align="center" bgcolor="<?= $bg_header; ?>" style="padding: 20px 0 20px 0;">
				...
				<a href="<?= $link_web; ?>" target="_blank" style="display:inline-block; border: 2px solid #ffffff;">
					...
					<img src="<?= $url_image; ?>" alt="Mail Template by Ingenioart - JGreen" width="160" height="80" style="display: block; background:white;" />

<?php
	...
	#Email soportado
	$admin_email = isset($options['theme_email_cuenta']) && !empty($options['theme_email_cuenta']) ? $options['theme_email_cuenta'] : 'informes@centralglam.com';
	...
	$mail->Subject = "Formulario Web: Central Glam";
